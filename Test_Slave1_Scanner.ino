/*
 * TEST - SLAVE 1 AS SCANNER
 * Check if Slave 1's ESP32 can scan and find other BLE devices
 */
...
void setup() {
  ...
  Serial.println("╔══════════════════════════════════════╗");
  Serial.println("║  SLAVE 1 ESP32 - SCANNER TEST       ║");
  Serial.println("║  Testing if this ESP32 can scan     ║");
  Serial.println("╚══════════════════════════════════════╝");
  
  BLEDevice::init("Slave1_Scanner");
  ...
  Serial.println("  - Should find NeoXalle_Slave_2 (if powered on)");
